  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
      ...
      <div className="text-center mb-6">
        <div className="relative mx-auto w-24 h-24 rounded-full bg-gradient-to-br from-blue-400 to-purple-500 flex items-center justify-center mb-4">
        ...
        {isEditing ? (
          <input
            ...
            className="text-xl font-bold text-gray-900 text-center w-full border-b border-gray-300 focus:outline-none focus:border-blue-500"
          />
        ) : (
